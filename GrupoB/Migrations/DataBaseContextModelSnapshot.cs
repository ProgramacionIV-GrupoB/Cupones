...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrupoB.Models.ArticuloModel", b =>
                {
            ...
            modelBuilder.Entity("GrupoB.Models.CategoriaModel", b =>
                {
            ...
            modelBuilder.Entity("GrupoB.Models.CuponModel", b =>
                {
            ...
            modelBuilder.Entity("GrupoB.Models.Cupon_CategoriaModel", b =>
                {
            ...
            modelBuilder.Entity("GrupoB.Models.Cupon_ClienteModel", b =>
                {
            ...
            modelBuilder.Entity("GrupoB.Models.Cupones_DetallesModel", b =>
                {
                    b.Property<int>("Id_Cupon")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrupoB.Models.Cupones_HistorialModel", b =>
                {
                    b.Property<int>("Id_Cupon")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrupoB.Models.PrecioModel", b =>
                {
            ...
            modelBuilder.Entity("GrupoB.Models.Tipo_CuponModel", b =>
                {
                    b.Property<int>("Id_Tipo_Cupon")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrupoB.Models.ArticuloModel", b =>
                {
                    b.HasOne("GrupoB.Models.PrecioModel", "Precio")
                        .WithMany()
            ...
            modelBuilder.Entity("GrupoB.Models.CuponModel", b =>
                {
                    b.HasOne("GrupoB.Models.Tipo_CuponModel", "Tipo_Cupon")
                        .WithMany()
            ...
            modelBuilder.Entity("GrupoB.Models.Cupon_CategoriaModel", b =>
                {
                    b.HasOne("GrupoB.Models.CategoriaModel", "Categoria")
                        .WithMany("Cupones_Categorias")
                        .HasForeignKey("Id_Categoria")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GrupoB.Models.CuponModel", "Cupòn")
                        .WithMany("Cupones_Categorias")
